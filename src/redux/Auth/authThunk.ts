import { currentUser, login, logout, register, sendHelp, updateUser } from "./api/api";
import { createAsyncThunk } from "@reduxjs/toolkit";
import { AuthBody, AuthResponse, UpdateUserParams, User } from "./types/interface"; // Імпорт необхідних типів
